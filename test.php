...
?>
	...
	<div class="row mt-3 mb-3">	
			...
			<div class="col-12 col-xs-12 col-sm-12 col-md-3 col-lg-4">
				<h3 class=" d-flex justify-content-center"><span class="backstage_title">訂貨紀錄修改</span></h3>
			</div>
	...
	<form  id="myform" name="myform" action="revise.php" method="post" enctype="multipart/form-data">	
      ...
      <button type="submit" name="submit" class="btn "   >&emsp;&emsp;確認&emsp;&emsp;</button>
    </div>		
