...
?>	
	...
	<script type="text/javascript">
		...
		department[0]=["大於20", "大於50", "小於80", "小於90", "20-90", "20-70","30-80","35-90","40-80","50-90","30-60","20-50"];	// 資訊系
		...
		{  
			var result=document.getElementById('company').value;
			 document.getElementById('work_case').value="";
			 document.forms['myform']['work_case'].value="";
			 var words="";
					 ...
					 for(var i=0;i<words.length-1;i++)
						 {	 if(words[i].length<22){
								 ...
								 datalist.appendChild(option1);
									...
									var option1 = document.createElement("option");
								    option1.value = words[i];
									 option1.label = words[i].substring(22,words[i].length);
									datalist.appendChild(option1);
				...
				xmlhttp.onreadystatechange=function(){
					if (xmlhttp.readyState==4 && xmlhttp.status==200)
						{ var words =xmlhttp.responseText;
							 var str=words.split("/");
						 document.forms['myform']['book_num'].value=str[0];
						 document.forms['myform']['tel'].value=str[3];
						   document.forms['myform']['user'].value=str[2];
						  
						// alert(words); 
						 var tmp=str[1].split(",");
						    department[0].unshift(tmp[0]);
						  renew(0);
						}
				}
		...
		<?php
		 ...
		 if(isset($_POST['submit'])){
			 ...
			 if (mysqli_query($db, $sql)) {	
				 ...
				 // line_call("新增訂單",$book_date,$company,$place,$work_case,$strength,$type."/".$quantity,$work_type,$code,$qc." ".$qc_time2,$user,$tel,$delivery.$delivery_time." ".$delivery_time2,$sale,$note,'1');
		 /*
		...
		<form id="myform" name="myform" action="new_form.php" method="post" enctype="multipart/form-data">
		 <!-- ?status_title=2-->
			...
			<div class="col-12 col-xs-12 col-sm-4 col-md-4 col-lg-4" style="margin-top:48px;" >
				<div style="text-align:left;"><font color='red'>
					今日訂貨量: CLSM: <?=$CLSM." / 一般料: ".$normal;?>方</font>
				</div>
			</div>
			 <div class="col-12 col-xs-12 col-sm-4 col-md-4 col-lg-4" style="margin-top:48px;">
			...
			<div class="col-12 col-xs-12 col-sm-4 col-md-4 col-lg-4 mt-2 mb-2" >
				<label>客戶：</label> 
				<input list="company-list" id="company" name="company" class="form-control" onchange="show_case(this.id)" required> 
			 ...
			 <div class="col-12 col-xs-12 col-sm-1 col-md-1 col-lg-1" > </div> 
			 <div class="col-12 col-xs-12 col-sm-1 col-md-1 col-lg-1" style="background-color:#fff;" > </div> 
			 <div class="col-10 col-xs-10 col-sm-8 col-md-8 col-lg-8 mt-2 mb-2">
			  <label>工程名稱：</label>
			  <input list="case-list" id="work_case" name="work_case"class="form-control" onchange="show_book_num(this.id)"  required> 
			...
			<div class="col-2 col-xs-2 col-sm-1 col-md-1 col-lg-1 " style="background-color:#fff;" >
				<button type="button" name="del" id="del" class="btn " style="margin-top:40px;"  onclick="dele()" >X</button>
			 </div>
			 <div class="col-12 col-xs-12 col-sm-1 col-md-1 col-lg-1" > </div>
			 ...
			 <div class="col-12 col-xs-12 col-sm-6 col-md-6 col-lg-6 mt-2 mb-2">
				<label>工地位置：</label>
				<input type="text" class="form-control" name="place" id="place" value="" required>
			 </div>
			 <div class="col-12 col-xs-12 col-sm-1 col-md-1 col-lg-1" style="background-color:#fff;" > </div>
			 <div class="col-12 col-xs-12 col-sm-1 col-md-1 col-lg-1" > </div> 
			...
			<div class="col-12 col-xs-12 col-sm-2 col-md-2 col-lg-2 mt-2 mb-2">
			 ...
			 <div class="col-12 col-xs-12 col-sm-2 col-md-2 col-lg-2 mt-2 mb-2">
				  <label>出貨時間：</label> 
				  <!--<input class="form-control content date" name="delivery" id="datepicker" value="" >-->
				  <input type="text" class="form-control" name="delivery_time2" id="delivery_time2" value=" " required>			 
			 </div>
			 <div class="col-12 col-xs-12 col-sm-2 col-md-2 col-lg-2 mt-2 mb-2" >
				<label>業務：</label> 
				<select class="form-control" name="sale" id="sale" >
					<?php
						...
						else if($name=="A00065"){echo' <option value="林宗達"selected>林宗達</option>';}
					?>
			...
			<div class="col-12 col-xs-12 col-sm-8 col-md-8 col-lg-8 mt-2 mb-2" >
				<center>
					<button type="submit" name="submit" id="submit" class="btn " style="margin-bottom:48px;" onmousedown="this.style.background='#009761';" >新增訂單</button>
				</center>
			</div>	
			<div class="col-12 col-xs-12 col-sm-1 col-md-1 col-lg-1" style="background-color:#fff; border-radius:10px;"></div>
			<div class="col-12 col-xs-12 col-sm-1 col-md-1 col-lg-1" > </div>
